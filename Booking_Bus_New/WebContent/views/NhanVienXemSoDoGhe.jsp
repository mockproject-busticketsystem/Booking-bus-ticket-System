...
<div class=right2>
		...
		<div id="main">
			<div id=head1 style="margin-top: -10px;">
				<div class=logo1>
					<p>Thông Tin Chuyến Đi</p>
				</div>
			</div>
		
			<div id="head2" style="margin-top: -5px;">
						<h4>
        ...
        <span>Ghế đang chọn </span>
          ...
          <br>
          <div class="ghekhongban" style="margin-top: -38px;">
          <div class="ml5"
            style="display: inline-block; width: 30px; height: 15px; 
          ...
          <br>
          <div class="ghechuachon" style="margin-top: -38px;margin-left: 83px;">
          <div class="ml5"
            style="display: inline-block; width: 30px; height: 15px;
