											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="bmd-label-floating">Số điện thoại</label> <input 
														type="text"  value = "${nv.sDT}" class="form-control" name = "SDT" pattern="[0-9]*.{10,11}" required>
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label class="bmd-label-floating">Họ và tên
													</label> <input type="text" value = "${nv.hoTen}" class="form-control" name = "HoTen" required>
												</div>
											</div>
										</div>
										<div class="row">
