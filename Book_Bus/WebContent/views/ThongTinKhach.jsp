					...
					<div class="row">
						...
						<ul class="fl social" style="list-style-type: none;">
							...
							<li><a href="https://in.linkedin.com/company/book-bus-asia"
								...
								<a
								href="https://plus.google.com/u/0/106337264178239365499/posts"
							...
							<li class="partners"><strong>Our Payments Partner</strong>
								<figure>
									<br>
									<img src="https://bookbus.asia:443/img/cc-avenue.png"
										alt="cc-avenue">
								</figure> <br> <br> <br> <span class="bbus_cmnsp card"
								id="icon_pay"> <i class="fa fa-cc-discover"
									style="font-size: 24px; color: #FFA500;"></i>&nbsp&nbsp <i
									class=" fa fa-cc-paypal"
									style="font-size: 24px; color: #7CFC00;"></i>&nbsp&nbsp <i
									class="fa fa-cc-visa" style="font-size: 24px; color: #1E90FF;"></i>&nbsp&nbsp
									<i class="fa fa-cc-jcb"
									style="font-size: 24px; color: #32CD32;"></i>&nbsp&nbsp <i
