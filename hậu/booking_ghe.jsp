...
<body>
<div class="plane">
 <h2 id="mang_ghe">tuyen : <%=request.getAttribute("idtuyen")%> <%=request.getAttribute("di")%>--> <%=request.getAttribute("den")%> </h2><h2>Giá : <%=request.getAttribute("dongia")%></h2>
  <div class="cockpit">
    <h2 id = "count">0</h2>
  ...
  <ol class="cabin fuselage">
    <li class="row row--1">
      <ol class="seats" type="A">
        ...
        <li class="seat">
          <input type="checkbox" id="1C" value="1C"  name="check" class="checkbox" disabled onclick ="array();"/>
